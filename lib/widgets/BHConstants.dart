...
const BHForgotPasswordSubTitle =
    "Veuillez entrer votre adresse e-mail afin que nous puissions vous aider à récupérer votre mot de passe.";
const BHVerificationTitle =
    "Enter the OTP code from the phone we just sent you";
const BHResetPasswordTitle =
    "Veuillez entrer votre nouveau mot de passe et confirmez-le.";
...
const BHTxtForgetPwd = 'Mot de passe oublié ?';
const BHBtnSignIn = 'Connectez-vous';
const BHTxtOrSignIn = 'Nos réseaux sociaux'; //'Ou connectez-vous avec';
const BHBtnSignUp = 'Sign Up';
const BHTxtAccount = "You have an account? ";
const BHTxtForgotPwd = 'Mot de passe oublié';
const BHBtnSend = 'Envoyer';
const BHTxtVerification = 'Verification';
const BHTxtResendOn = 'Resend on';
const BHBtnContinue = 'Continue';
const BHBtnOk = 'Ok';
const BHBtnNo = 'No';
const BHTxtResetPwd = 'Réinitialiser le mot de passe';
