...
import 'package:maelys_imo/pages/checkout.dart';
import 'package:maelys_imo/provider/auth.dart';
import 'package:maelys_imo/widgets/loading.dart';
import 'package:provider/provider.dart';

class PaiemenOrangePage extends StatefulWidget {
  const PaiemenOrangePage({Key? key}) : super(key: key);
  static const route = "/paiement_page";
  @override
  _PaiemenOrangePageState createState() => _PaiemenOrangePageState();
}

class _PaiemenOrangePageState extends State<PaiemenOrangePage> {
  ...
  List<int> numberOfMonth = [1, 2, 3, 4, 5, 6, 7, 8, 9];
  int? _numberOfMonth = 1;
  ...
  Future paiementApi() async {
    ...
    if (res['status'] == true) {
      ...
      String trans_id = res['response']['transactionId'];
      int numberOfMonth = int.parse(res['response']['numberOfMonth']);
      String token = res['response']['trans_token'];
      String link = res['response']['link'];
      if (link.isNotEmpty) {
                                              ...
                                              child: TextFormField(
                                                ...
                                                validator: (value) {
                                                  if (value!.isEmpty ||
                                                      !(value.substring(0, 2) ==
                                                          "07")) {
                                                    return 'Veuillez entrer un numero ORANGE SVP';
                                                  }
                                                  return null;
                                                },
                                                onSaved: (value) {
